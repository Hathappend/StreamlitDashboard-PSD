...
df_aotizhongxin  = load_data("https://raw.githubusercontent.com/Tomath02/uasPDSD/main/PRSA_Data_20130301-20170228/PRSA_Data_Aotizhongxin_20130301-20170228.csv")
df_changping     = load_data('https://raw.githubusercontent.com/Tomath02/uasPDSD/main/PRSA_Data_20130301-20170228/PRSA_Data_Changping_20130301-20170228.csv')
df_dingling      = load_data('https://raw.githubusercontent.com/Tomath02/uasPDSD/main/PRSA_Data_20130301-20170228/PRSA_Data_Dingling_20130301-20170228.csv')
df_dongsi        = load_data('https://raw.githubusercontent.com/Tomath02/uasPDSD/main/PRSA_Data_20130301-20170228/PRSA_Data_Dongsi_20130301-20170228.csv')
df_guanyuan      = load_data('https://raw.githubusercontent.com/Tomath02/uasPDSD/main/PRSA_Data_20130301-20170228/PRSA_Data_Guanyuan_20130301-20170228.csv')
df_gucheng       = load_data('https://raw.githubusercontent.com/Tomath02/uasPDSD/main/PRSA_Data_20130301-20170228/PRSA_Data_Gucheng_20130301-20170228.csv')
df_huairou       = load_data('https://raw.githubusercontent.com/Tomath02/uasPDSD/main/PRSA_Data_20130301-20170228/PRSA_Data_Huairou_20130301-20170228.csv')
df_nongzhanguan  = load_data('https://raw.githubusercontent.com/Tomath02/uasPDSD/main/PRSA_Data_20130301-20170228/PRSA_Data_Nongzhanguan_20130301-20170228.csv')
df_shunyi        = load_data('https://raw.githubusercontent.com/Tomath02/uasPDSD/main/PRSA_Data_20130301-20170228/PRSA_Data_Shunyi_20130301-20170228.csv')
df_tiantan       = load_data('https://raw.githubusercontent.com/Tomath02/uasPDSD/main/PRSA_Data_20130301-20170228/PRSA_Data_Tiantan_20130301-20170228.csv')
df_wanliu        = load_data('https://raw.githubusercontent.com/Tomath02/uasPDSD/main/PRSA_Data_20130301-20170228/PRSA_Data_Wanliu_20130301-20170228.csv')
df_wanshouxigong = load_data('https://raw.githubusercontent.com/Tomath02/uasPDSD/main/PRSA_Data_20130301-20170228/PRSA_Data_Wanshouxigong_20130301-20170228.csv')
...
with st.sidebar :
    selected = option_menu('Menu',['Dashboard', 'Udara Buruk', 'Pengaruh Polutan', 'Arah Angin', 'Pengaruh Hujan'],
    icons =["easel2"],
    menu_icon="cast",
    default_index=0)

if (selected == 'Dashboard') :
    st.header(f"Dashboard Hasil Analisis Kualitas Udara")
    st.markdown("***")
    ...
    with col1:
        st.markdown(
            '''
            <div class='card'>
                Ini adalah konten dari kartu dengan border.
            </div>
            ''', 
    ...
    with col2:
        col2.markdown(
            '''
            <div class='card'>
                <img class="image" src='https://e1.pxfuel.com/desktop-wallpaper/459/625/desktop-wallpaper-handsome-squidward.jpg'>
                Ini adalah konten dari kartu dengan border.
            </div>
            ''', 
            unsafe_allow_html=True)
    ...
    st.header("Pengaruh hujan terdapap tingkat partikel polutan")
    st.markdown("***")
